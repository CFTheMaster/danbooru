  ...
  class InvitationsControllerTest < ActionDispatch::IntegrationTest
    context "The invitations controller" do
      ...
      should "render the new page" do
        get_auth :new:_path, @mod, params: {:invitation => {:name => @user_1.name}}
        assert_response :success
      end

      should "create a new invite" do
        post_auth :create:_path, @mod, params: {:invitation => {:user_id => @user_1.id, :level => User::Levels::BUILDER, :can_upload_free => "1"}}
