    ...
    class PostsControllerTest < ActionDispatch::IntegrationTest
      context "The moderator posts controller" do
        ...
        context "confirm_delete action" do
          should "render" do
            get_auth :confirm_delete:_path, @admin, params: { id: @post.id }
        ...
        context "delete action" do
          should "render" do
            post_auth :delete:_path, @admin, params: {:id => @post.id, :reason => "xxx", :format => "js", :commit => "Delete"}
        ...
        context "undelete action" do
          should "render" do
            ...
            post_auth :undelete:_path, @admin, params: {:id => @post.id, :format => "js"}
        ...
        context "confirm_move_favorites action" do
          should "render" do
            get_auth :confirm_move_favorites:_path, @admin, params: { id: @post.id }
            assert_response :success
          end
        end
        ...
        context "move_favorites action" do
          ...
          should "1234 render" do
            ...
            put_auth :move_favorites:_path, @admin, params: { id: child.id, commit: "Submit" }
        ...
        context "expunge action" do
          should "render" do
            put_auth :expunge:_path, @admin, params: { id: @post.id, format: "js" }
        ...
        context "confirm_ban action" do
          should "render" do
            get_auth :confirm_ban:_path, @admin, params: { id: @post.id }
            assert_response :success
          end
        end
        ...
        context "ban action" do
          should "render" do
            put_auth :ban:_path, @admin, params: { id: @post.id, commit: "Ban", format: "js" }
        ...
        context "unban action" do
          should "render" do
            @post.ban!
            put_auth :unban:_path, @admin, params: { id: @post.id, format: "js" }
