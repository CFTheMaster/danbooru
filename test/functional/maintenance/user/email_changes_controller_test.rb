      ...
      context "in all cases" do
        ...
        context "#create" do
          context "with the correct password" do
            should "work" do
              post_auth :create:_path, @user, params: {:email_change => {:password => "password", :email => "abc@ogres.net"}}
          ...
          context "with the incorrect password" do
            should "not work" do
              post_auth :create:_path, @user, params: {:email_change => {:password => "passwordx", :email => "abc@ogres.net"}}
              @user.reload
