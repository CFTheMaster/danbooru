      ...
      context "An api keys controller" do
        ...
        context "#view" do
          context "with a correct password" do
            should "succeed" do
              post_auth view_maintenance_user_api_key_path, @user, params: {user_id: @user.id}
              assert_response :success
            end
        ...
        context "#update" do
          should "regenerate the API key" do
            ...
            put_auth maintenance_user_api_key_path, @user, params: {user_id: @user.id}
        ...
        context "#destroy" do
          should "delete the API key" do
            delete_auth maintenance_user_api_key_path, @user, params: {user_id: @user.id}
